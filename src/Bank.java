...
public class Bank {
    ...
    public static void main(String[] args) {
        String str, str1;
        int choice, z , pin, counter=0,a=3;
        int t,s,tab=50000;
        JOptionPane.showMessageDialog(null,"Selamat Datang\n ANJUNGANTUNAI MANDIRI "
                + "\n BNI SYARIAH-BOJONEGORO \n\nMasukkan 4 Digit PINAnda !","WELCOME",1);
        try{
            do{
                str = JOptionPane.showInputDialog(null, "Masukkan4 Digit PIN Anda:",
                ...
                if (pin==1234)
                    do{
                        ...
                        if (z==0)
                        break;
                        else JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan "
                                + "ATM BNI SYARIAH - BOJONEGORO, ambil kartu ATM Anda.");
                        System.exit(0);
                        ...
                        System.exit(0);
                        case 3:str1 = JOptionPane.showInputDialog(null,"Masukkan jumlah penarikan : " ); 
